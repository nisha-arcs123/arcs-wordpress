...
<div class="outer-box-ai-ml-page p-rel o-h">
    ...
    <div class="ui-banner full-vh p-rel">
        ...
        <div class="ios-app-right user-box-2 user-box z-1 padding-8">
            <div class="banner-icon">
                <img src="<?php echo get_template_directory_uri() ?>/images/AI-ML-icon-4.svg" alt="">
            </div>
            <span>Education</span>
        </div>

        <div class="ios-app-left user-box-2 z-1 user-box padding-8">
            <div class="banner-icon">
                <img src="<?php echo get_template_directory_uri() ?>/images/AI-ML-icon-3.svg" alt="">
            </div>
            <span>Healthcare</span>
        </div>

        <div class="ios-app-bottom user-box-1 z-1 user-box padding-8">
            <div class="banner-icon">
                <img src="<?php echo get_template_directory_uri() ?>/images/AI-ML-icon-1.svg" alt="">
            </div>
            <span>AI Solutions</span>
        </div>

        <div class="ai-bot z-1 user-box-1 user-box padding-8">
            <div class="banner-icon">
                <img src="<?php echo get_template_directory_uri() ?>/images/AI-ML-icon-2.svg" alt="">
            </div>
            <span>Chat with AI bot</span>
        </div>

        <div class="z-1 banner-girl-image">
            <img class="z-1 p-rel" src="<?php echo get_template_directory_uri() ?>/images/ai-ml-banner-img.svg" alt="">
            <img class="banner-gif" src="<?php echo get_template_directory_uri() ?>/images/ai-gif-ai-ml-banner.gif" alt="">
        </div>
    ...
    <div class="business-growth-wrapper w-full">
        <div class="business-growth-outer p-rel w-full">
    ...
    <div class="transform-future-wrapper w-full padding-40 bx-border-box">
        <div class="transform-future wds m-auto">
            <div class="left-part">
                ...
                <p class="card-content mt-0"><?php the_field('section2-descriptionai') ?> </p>
                <button class="primary-button mt-32">LET'S WORK TOGETGHER</button>
            </div>
            <div class="right-part padding-20 bx-border-box">
                <img class="w-full" src="<?php echo get_template_directory_uri() ?>/images/ai-ml-section-3-img.svg" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="cs-remarkable-benefits-wrapper m-auto">
        ...
        <p class="section-content mt-0 m-auto tx-center mb-40 as-main-content"><?php the_field('Section3-descriptionai') ?></p>
    ...
    <div class="ai-solutions w-full">
        <p class="section-heading mt-0 mb-12 tx-center"><?php the_field('section5-headingai') ?></p>
        <p class="section-content m-auto tx-center as-main-content as-main-content m-auto"><?php the_field('section5-descriptionai') ?></p>
