            ...
            <div class="text-section o-h p-rel">
                <div class="section">
                    ...
                    <ul class="points padding-0 mt-0 mb-0">
                        ...
                        <li class="card-content mb-4 p-rel">education and Training</li>
                        <li class="card-content mb-4 p-rel">Food and Beverage</li>
                        <li class="card-content mb-4 p-rel">Healthcare</li>
                        <li class="card-content mb-4 p-rel">Sports and Fitness</li>
                        <li class="card-content mb-4 p-rel">Retail and Ecommerce</li>
                    </ul>
                </div>
            </div>
            </div>
        ...
        <div class="app-development mt-120">
            ...
            <div class="parts wds m-auto bx-border-box padding-30">
                <div class="box p-rel">
                    ...
                    <p class="card-content card-content">We can help you deploy effective and user-friendly apps designed for Apple products like iPhones and iPads.
                ...
                <div class="box p-rel">
                    <div class="logo-n-heading mb-8">
                        ...
                        <span class="card-title">Cross-platform</span>
                    </div>
                    <p class="card-content card-content">Have you ever noticed that some popular apps are only available on Android or iOS, not both? That's often
                ...
                <div class="box p-rel">
                    ...
                    <p class="card-content card-content">Our Android team understands the complexities of developing for a marketplace accessed by a vast range of devices
