...
<div class="outer-box-mobile-page w-full ox-h">
        ...
        <div class="image-text-section-wrapper w-full z-1 p-rel">
          ...
          <div class="text-section o-h p-rel">
              ...
              <div class="section">
                  ...
                  <p class="inner-content mb-32 z-1 p-rel"><?php the_field('mobile_section_1_content')?></p>
        ...
        <div class="start-your-project p-rel mt-120">
        ...
        <div class="transform-future-wrapper w-full padding-40 bx-border-box">
          <div class="transform-future wds m-auto">
              <div class="left-part">
                    ...
                    <p class="section-content mt-0 mb-32"><?php the_field('mobile_section_3_content')?></p>
            ...
            <div class="aspects w-full bx-border-box padding-40 p-rel">
                ...
                <div class="boxes">
                    <div class="box aspect-card1 padding-20 bx-border-box">
                        ...
                        <p class="box-text mb-0 hover-effect">Designing and developing powerful iOS apps that truly represent the value of your brand.</p>
                    </div>
                    ...
                    <div class="box aspect-card2 padding-20 bx-border-box">
                        ...
                        <p class="box-text mb-0 hover-effect">Creating custom-made enterprise iOS apps that help your business grow.</p>
                    </div>
                    ...
                    <div class="box aspect-card3 padding-20 bx-border-box">
                        ...
                        <h4 class="box-heading mt-0 mb-8 hover-effect">iOS App Optimisation</h4>
                        <p class="box-text mb-0 hover-effect">Using crash data analysis and code reviews to optimize your iOS apps.</p>
                    </div>
                    ...
                    <div class="box aspect-card4 padding-20 bx-border-box">
                        ...
                        <h4 class="box-heading mt-0 mb-8 hover-effect">iOS App Redesign</h4>
                        <p class="box-text mb-0 hover-effect">Redesigning iOS apps into exceptional products with design-led engineering.</p>
                    </div>
                </div>
            </div> 
        </div>
        ...
        <div class="transform-future-wrapper w-full padding-40 bx-border-box">
            <div class="transform-future-alternate wds m-auto">
                <div class="left-part">
                    ...
                    <p class="section-content mt-0 mb-32"><?php the_field('mobile_section_5_content')?></p>
                    <button class="primary-button">Let's Work Together</button>
                </div>
                <div class="right-part padding-20 bx-border-box">
        ...
        <div class="full-spectrum-outer w-full">
            ...
            <p class="fs-normal-text mb-40 mt-0"><?php the_field('mobile_section_6_content')?></p>
            <div class="full-spectrum-cards">
                ...
                <div class="full-spectrum-inner card1">
                    ...
                    <p class="text margin-0">Plotting out the app itself is just one part of the solution; ensuring your mobile app is integrated into your
                ...
                <div class="full-spectrum-inner card2">
                    ...
                    <p class="text margin-0">Your business performance is tightly aligned with your mobile app performance. Our app development consultants
                ...
                <div class="full-spectrum-inner card3">
                    ...
                    <p class="text margin-0">Having been at the forefront of mobile app development since the dawn of the mobile app (2007), we have 
                ...
                <div class="full-spectrum-inner card4">
                    ...
                    <p class="text margin-0">One of the smartest ways to maximize your budget, efficiency, and impact is to update your mobile app’s features
