    ...
    <?php get_header(); ?>
     ...
     <div class="ui-banner full-vh p-rel">
        ...
        <div class="ui-banner-details z-2">
            <h1 class="inner-banner-heading mb-16 mt-0 m-auto tx-center"><?php echo the_field('contact_us_banner_heading'); ?></h1>
            <p class="inner-banner-content mb-28 mt-0 m-auto tx-center"><?php echo the_field('contact_us_banner_content'); ?></p>
