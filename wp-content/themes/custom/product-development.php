...
<div class="outer-box-product-page p-rel o-h">
 ...
 <div class="ui-banner full-vh p-rel">
        ...
        <div class="transform-future-wrapper w-full padding-40 bx-border-box">
            <div class="transform-future wds m-auto">
                <div class="left-part">
                    ...
                    <p class="section-content mt-0 mb-32"><?php echo the_field('product_section1_description'); ?></p>
        ...
        <div class="ai-solutions w-full">
          ...
          <div class="as-boxes bx-border-box wds m-auto">
              ...
              <div class="as-box p-rel padding-16 bx-border-box">
                  ...
                  <p class="section-content inner-section-content mt-0 mb-0">Use AI to interpret visual data for facial recognition, medical imaging, 
        ...
        <div class="key-features">
            ...
            <p><?php echo the_field('product_section4_heading'); ?> <b><?php echo the_field('product_section3_span_heading'); ?> </b></p>
          ...
          <div class="divs div1">
            <div class="upper-div">
              ...
              <p>Tailored to your specific goals and audience.</p>
          </div>
          <div class="divs div2">
            <div class="upper-div">
              <div class="img-div">
              ...
              <p>Ensuring ease of use and accessibility.</p>
          </div>
          <div class="divs div3">
            <div class="upper-div">
              <div class="img-div">
              ...
              <p>Built for long-term growth and adaptability.</p>
          </div>
          <div class="divs div4">
            <div class="upper-div">
              <div class="img-div">
              ...
              <h3>SEO-Friendly Approach</h3>
              <p>Optimized for better visibility in search engines.</p>
          </div>
          <div class="divs div5">
            <div class="upper-div">
              <div class="img-div">
              ...
              <p>Keeping your website fresh and functional.</p>
          </div>
            ...
            <div class="boxes-wrapper wds m-auto bx-border-box">
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-28 mb-0">Discovery & Planning</p>
                    </div>
                    <p class="section-content mt-0 mb-0">Understand your goals, audience, and requirements.
                ...
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Wireframing & Prototyping </p>
                    </div>
                    <p class="section-content mt-0 mb-0">Create blueprints and prototypes to visualize the website's structure and design.
                ...
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Design & (UI/UX)</p>
                    </div>
                    <p class="section-content mt-0 mb-0">Focus on responsive layouts, accessibility, and seamless navigation.</p>
                </div>
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Daily Life Enhancements</p>
                    </div>
                ...
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Smarter Decision-Making</p>
                    </div>
                ...
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Innovation</p>
                    </div> 
                ...
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Cost Reduction</p>
                    </div>
                ...
                <div class="box mb-28 padding-20 bx-border-box">
                    <div class="upper-part">
                        ...
                        <p class="box-heading mt-20 mb-0">Data-Driven Insights</p>
                    </div>
